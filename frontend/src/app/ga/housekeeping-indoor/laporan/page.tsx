...
// ==================================================
// FILE: frontend/src/app/ga/housekeeping-indoor/laporan/page.tsx
// FUNGSI: Laporan kebersihan per lokasi - form/list drag-drop foto
// (dipindah dari ga/housekeeping-indoor/page.tsx begitu modul ini
// dapat sidebar + dashboard tetap, lihat layout.tsx)
// ==================================================
...
export default function LaporanHousekeepingIndoorPage() {
  ...
  return (
    <div className={styles.page}>
      <div className={styles.breadcrumb}>
        <Link href="/ga/housekeeping-indoor/dashboard">Housekeeping Indoor</Link>
        <span>/</span>
