...
// ==================================================
// FILE: frontend/src/app/administrasi/postingan/kelola/page.tsx
// FUNGSI: Kelola Postingan (poster/video) yang tampil di carousel
// beranda. Kelola: Admin/Admin HC/Admin Comben/Section Head.
// (Dipindah dari administrasi/postingan/page.tsx saat modul ini dapat
// sidebar+dashboard - lihat administrasi/postingan/layout.tsx)
// ==================================================
...
export default function KelolaPostinganPage() {
  ...
  return (
    <div className={styles.page}>
      <div className={styles.breadcrumb}>
        <Link href="/administrasi/postingan">Postingan</Link>
        <span>/</span>
      ...
      <div className={styles.pageHead}>
        ...
        <div className={styles.headActions}>
          ...
          <Link href="/administrasi/postingan" className={`${styles.btn} ${styles.btnGhost}`}>
            <ArrowLeft size={15} />
            Kembali
          </Link>
        </div>
