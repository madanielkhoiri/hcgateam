...
const administrasiTree: MenuTreeNode[] = [
  ...
  },
  {
    ...
    title: 'Dokumentasi',
    description: 'Album foto dokumentasi kegiatan.',
    status: 'Tersedia',
    href: '/administrasi/dokumentasi',
    icon: BookOpen,
  ...
  },
  {
    ...
    title: 'Form Download',
    description: 'Formulir-formulir resmi yang dapat diunduh, tersimpan dalam folder.',
    status: 'Tersedia',
    href: '/administrasi/form-download',
    icon: Download,
  ...
  },
  {
    ...
    title: 'CSR',
    description: 'Proposal, laporan, dan dokumen kegiatan CSR, tersimpan dalam folder.',
    status: 'Tersedia',
    href: '/administrasi/csr',
    icon: HandHeart,
