...
// ==================================================
// FILE: frontend/src/app/administrasi/dokumentasi/album/page.tsx
...
// (Dipindah dari administrasi/dokumentasi/page.tsx saat modul ini dapat
// sidebar+dashboard - lihat administrasi/dokumentasi/layout.tsx)
// ==================================================
  ...
  return (
    <div className={styles.page}>
      <div className={styles.breadcrumb}>
        <Link href="/administrasi/dokumentasi">Dokumentasi</Link>
        <span>/</span>
        {albumAktif ? (
          <>
            <button
        ...
        <>
          <div className={styles.pageHead}>
            ...
            <div className={styles.headActions}>
              ...
              <Link href="/administrasi/dokumentasi" className={`${styles.btn} ${styles.btnGhost}`}>
                <ArrowLeft size={15} />
                Kembali
              </Link>
            </div>
