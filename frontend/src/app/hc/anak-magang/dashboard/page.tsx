...
// FUNGSI: Dashboard Database Anak Magang - halaman pertama begitu masuk
// sidebar Anak Magang. Statistik + grafik pakai komponen reusable
// (StatCardRow, AnimatedLineChart, SimplePieChart), lalu daftar &
// pengelolaan anak magang (dipindah dari anak-magang/page.tsx lama) di
// bawahnya.
// ==================================================
