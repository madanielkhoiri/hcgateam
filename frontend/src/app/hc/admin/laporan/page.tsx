 ...
 */
 ...
 <div className="relative overflow-hidden rounded-[34px] bg-linear-to-br from-[#0757d1] via-[#0868f6] to-[#4f9cf9] px-5 py-7 text-white shadow-[0_18px_60px_rgba(8,104,246,0.22)] md:px-8 md:py-8">
 ...
 {pesanError && (
 <div className="mt-5 rounded-2xl border border-[#f3c2c2] bg-[#fff0f0] px-4 py-3 text-sm font-semibold text-[#b02031]">
 {pesanError}
 </div>
 )}
 ...
 <div className="flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 focus-within:border-[#0868f6]">
 ...
 <>
 <div className="mb-4 h-1.5 w-full rounded-full bg-[#0868f6]" />
...
function BagianWeb({
 ...
 return (
 <section className="mt-6 rounded-[32px] border border-[#d8e4f2] bg-white p-5 shadow-[0_18px_60px_rgba(15,23,42,0.08)] md:p-6">
 <div className="mb-5 h-1.5 w-full rounded-full bg-[#0868f6]" />
...
function KartuRingkasan({
 ...
 return (
 <div className="rounded-3xl border border-[#d8e4f2] bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.06)]">
