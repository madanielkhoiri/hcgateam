...
import { Database, Printer, RefreshCw } from "lucide-react";
...
async function ambilData() {
 ...
 <div className="rounded-2xl bg-[#eaf2ff] p-3 text-[#0868f6]">
 <Database className="h-7 w-7" />
 </div>

 <div>
 <p className="text-xs font-black uppercase tracking-[0.28em] text-[#0868f6]">
 Database Settlement
 </p>
 ...
 className="inline-flex items-center gap-2 rounded-2xl bg-[#0868f6] px-4 py-3 text-sm font-black !text-white hover:bg-[#0757d1]"
 >
 ...
 <p className="mt-2 text-3xl font-black text-[#0868f6]">
 ...
 {pesanError && (
 <div className="rounded-2xl border border-[#f3c2c2] bg-[#fff0f0] p-4 text-sm font-bold text-[#b02031] print:hidden">
 {pesanError}
 </div>
 )}
 ...
 className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-bold text-slate-700 outline-none focus:border-[#0868f6] focus:bg-white"
 >
